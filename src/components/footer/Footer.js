					...
					<div className = 'row mb-4'>
						<div className = 'c col-lg-4 col-md-6 col-12'>
							<div className = 's mb-3 mb-md-0'>
								<h6 className = 'footer-title mb-3'>Old Boys AMU Aligarh</h6>
								<p className = 'footer-text'>Website under development.We are thrilled to have you as part of our Old Boys Association family, and we look forward to seeing you at our upcoming events and reunions! </p>
								<h6 className = 'footer-e-mail text-muted'><i className = 'fas fa-envelope me-2'></i>sampleemail@support.com</h6>
							</div>
						</div>
