					...
					<div className = 'card mx-auto shadow-lg mb-5' key = {index}>
						...
						<div className = 'card-body p-4'>
							...
							<div className = '_footer d-flex flex-wrap justify-content-between align-items-center'>
								<button className = 'btn btn-success text-capitalize mb-3 btn-sm'>read more <i className = 'fas fa-chevron-right ms-2'></i></button>
		...
		return (
			<div className = 'sections blogs _rs py-5 mb-5'>
				<div className = 'container'>
					...
					<h4 className='sub-title text-capitalize'>recent <span style={{ color: '#376d4e' }}>Events</span></h4>
						...
						<div className = '_s row justify-content-start'>
							...
							<div className = 'rs text-center'>
								<Link className = 'blogs text-capitalize' to = '/blogs'>see all events of ours <i className = 'fas fa-arrow-right ms-2'></i></Link>
							</div>
						</div>
					</div>
				</div>
